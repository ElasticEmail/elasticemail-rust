...
pub struct FileUploadResult {
    ...
    #[serde(rename = "DuplicatedEmailsCount", skip_serializing_if = "Option::is_none")]
    pub duplicated_emails_count: Option<i32>,
}

impl FileUploadResult {
    pub fn new() -> FileUploadResult {
        FileUploadResult {
            emails_count: None,
            duplicated_emails_count: None,
        }
    }
}
