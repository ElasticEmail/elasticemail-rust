...
pub struct CampaignRecipient {
    ...
    #[serde(rename = "ListNames", skip_serializing_if = "Option::is_none")]
    pub list_names: Option<Vec<String>>,
    /// Names of segments from your Account to read recipients from
    #[serde(rename = "SegmentNames", skip_serializing_if = "Option::is_none")]
    pub segment_names: Option<Vec<String>>,
}

impl CampaignRecipient {
    /// A set of lists and segments names to read recipients from
    pub fn new() -> CampaignRecipient {
        CampaignRecipient {
            list_names: None,
            segment_names: None,
        }
